...
function DownloadElasticsearch {
    ...
    $downloadUrl =  "https://download.elasticsearch.org/elasticsearch/release/org/elasticsearch/distribution/zip/elasticsearch/2.0.0-beta2/elasticsearch-2.0.0-beta2.zip"
